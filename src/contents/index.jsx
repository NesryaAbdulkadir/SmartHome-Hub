export const product = [
  {
    ...
    overView:
      "SmartHome Hub is an all-in-one smart home controller designed to simplify and enhance the management of your smart devices. With its intuitive interface and powerful automation capabilities, SmartHome Hub allows users to control lighting, security, climate, and entertainment systems from a single app, making it the perfect solution for tech-savvy homeowners seeking convenience and efficiency.",
    features: [
      {
